...
2. The data used in the analysis is the version MERGING in provider sheet data. We curated the data by adding 
...
**Note** The cound of unique location name does not include provider level data lines. 
