...
1. Find and delete the one false positive CIC Dr. Hall found 
2. Decide about "comparable" inspection category. I think public mental health providers and private mental health providers are comparable. Now only private (CIC) providers are comparable. How adding the provider level data change the landscape? Need to check. 
...
spinout <- read_csv("D:/Archive/Socialcare UK/data/spinout_list_2017.csv")
```
...
locations<- read_excel("D:/Archive/Socialcare UK/data/2017_rating.xlsx", sheet = 2)
```
...
```{r}
write_csv(combined_2levels, "D:/Archive/Socialcare UK/data/spinout_2017.csv")
```
